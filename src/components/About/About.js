      ...
      <div className="container">
        ...
        <div className="row text-white mt-5 pt-5 align-items-center">
          ...
          <div className="col-md-6">
            <Slide bottom>
              <p>
                Hi there, this is Mahfuz. Always love to do programming and try
                to learn new thing about programming. I count myself among the
                hardworking person. My goal is to become a world-class web
                developer and to accept the challenge of developing a project.
              </p>
              <Link
                target="blank"
                to="//drive.google.com/u/0/uc?id=1GC8u-okBprnWivRCrDoteSEpnl91a-Ge&export=download"
              >
          ...
          <div className="col-md-6">
            <div className="text-white">
              ...
              <div className="row ml-2 mt-2 mb-2">
                ...
                <span className="skill-style">Bootstrap5</span>
              </div>
              ...
              <div className="row ml-2 mt-2 mb-2">
                ...
                <span className="skill-style">SASS</span>
                <span className="skill-style">TypeScript</span>
                <span className="skill-style">React Redux</span>
                <span className="skill-style">React Native</span>
              </div>
              <h5 className="skill-name">Tools:</h5>
              <div className="row ml-2 mt-2 mb-2">
                <span className="skill-style">Git</span>
                <span className="skill-style">Chrome Dev Tool</span>
                <span className="skill-style">VsCode</span>
                <span className="skill-style">Github</span>
                <span className="skill-style">Firebase</span>
                <span className="skill-style">NPM</span>
